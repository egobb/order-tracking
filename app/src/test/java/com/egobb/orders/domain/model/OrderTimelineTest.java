...
public class OrderTimelineTest {
  ...
  void register_validTransition_accumulatesDomainEvent_and_updatesState() {
    ...
    final var ev =
        new TrackingEventVo("o1", Status.OUT_FOR_DELIVERY, Instant.parse("2024-01-01T10:00:00Z"));
  ...
  void register_invalidTransition_returnsFalse_and_noDomainEvents() {
    ...
    final var ev =
        new TrackingEventVo("o1", Status.OUT_FOR_DELIVERY, Instant.parse("2024-01-01T12:00:00Z"));
