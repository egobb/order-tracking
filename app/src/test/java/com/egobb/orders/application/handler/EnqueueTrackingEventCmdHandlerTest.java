...
class EnqueueTrackingEventCmdHandlerTest {
	...
	@InjectMocks
	EnqueueTrackingEventCmdHandler handler;

	@Test
	void handle_maps_and_publishes_event() {
		// Arrange
		final var cmd = new EnqueueTrackingEventCmd("ORDER-1", Status.DELIVERED, Instant.parse("2025-01-01T12:00:00Z"));
		final var event = new TrackingEventReceived("ORDER-1", Status.DELIVERED, Instant.parse("2025-01-01T12:00:00Z"));
